...
export default function JobsDetails() {
  ...
  return (
    // <section className="relative min-h-screen overflow-hidden bg-black px-4 py-8 sm:px-6 lg:px-8 lg:py-32">
    <section className="relative min-h-screen overflow-hidden bg-transparent px-4 py-8 sm:px-6 lg:px-8 lg:py-32">
            ...
            <div className="grid lg:grid-cols-[1.35fr_380px]">
              ...
              <div className="p-6 sm:p-8 lg:p-10">
                ...
                <div className="space-y-4">
                  <h1 className="max-w-3xl font-mont text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
                    {singleJob?.title}
                  </h1>
              ...
              <div className="border-t border-white/10 bg-white/5 p-6 sm:p-8 lg:border-l lg:border-t-0">
                <div className="space-y-5 lg:sticky lg:top-24">
                  <div className="rounded-[28px] border border-white/10 bg-[#141822]/80 p-5 shadow-[0_12px_40px_rgba(0,0,0,0.35)] backdrop-blur-xl">
                    <p className="font-mont text-xs uppercase tracking-[0.2em] text-white/40">
                      Application Panel
                    </p>

                    <h2 className="mt-3 font-mont text-2xl font-bold text-white">
                    ...
                    <Button
                      ...
                      className={`mt-5 h-12 w-full rounded-full border-0 font-mont text-sm font-medium transition ${isApplied
                  ...
                  <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 backdrop-blur-xl">
                    <p className="mb-4 font-mont text-sm font-semibold text-white">
                      Quick Snapshot
                    </p>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_360px]">
          ...
          <div className="space-y-6">
            <GlassSection title="Job Description">
              <p className="font-mont text-sm leading-7 text-white/70 sm:text-[15px]">
              ...
              <ul className="space-y-3">
                {(
                  ...
                  >
                    ...
                    <span className="font-mont text-sm leading-6 text-white/75">
                      {item}
                    </span>
                  </li>
                ))}
            ...
            <GlassSection title="Required Skills">
              <div className="flex flex-wrap gap-2.5">
                {(singleJob?.requirements || []).map((skill: string) => (
                  <Badge
                    key={skill}
                    className="rounded-full border border-cyan-400/15 bg-cyan-400/10 px-4 py-2 font-mont text-sm font-medium text-cyan-100 hover:bg-cyan-400/15"
                  >
                    {skill}
                  </Badge>
                ))}
          ...
          <div className="space-y-6">
            ...
            <GlassSidebarCard title="Company Info">
              <div className="flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-cyan-300 backdrop-blur-lg">
                  <Building2 className="h-7 w-7" />
                </div>

                <div>
                  <h3 className="font-mont text-base font-semibold text-white">
                    {singleJob?.company?.name || "Company"}
                  </h3>
              ...
              <Button
                variant="outline"
                className="mt-5 h-11 w-full rounded-full border-white/15 bg-white/5 font-mont text-white hover:bg-white/10 hover:text-white"
              >
                View Company
              </Button>
            </GlassSidebarCard>
              ...
              <CardContent className="relative p-6">
                ...
                <div className="relative">
                  <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1">
                    <p className="font-mont text-[11px] uppercase tracking-[0.2em] text-white/55">
                      Career Move
                    </p>
                  </div>

                  <h3 className="mt-4 font-mont text-2xl font-semibold leading-tight text-white">
                    Ready to apply?
                  </h3>
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    ...
                    <Button
                      variant="outline"
                      className="h-11 rounded-full border-white/15 bg-white/5 px-5 text-sm text-white hover:bg-white/10 hover:text-white"
                    >
                      Save Job
                    </Button>
                  </div>
...
function StatCard({
  ...
  return (
    <div className="rounded-[24px] border border-white/10 bg-white/5 p-4 shadow-[0_6px_30px_rgba(0,0,0,0.2)] backdrop-blur-xl">
      ...
      <p className="mt-1 font-mont text-sm font-semibold text-white">
        {value}
      </p>
    </div>
  );
...
function MiniInfo({
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-[#161a24]/70 px-4 py-3">
      <p className="font-mont text-sm text-white/50">{label}</p>
      <p className="font-mont text-sm font-semibold text-white">{value}</p>
    </div>
  );
}
