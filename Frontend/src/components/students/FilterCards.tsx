...
const filterData = [
  {
    ...
    icon: MapPin,
    key: "location",
    options: ["Pune", "Mumbai", "Bangalore", "Delhi", "Remote"],
  },

  {
    ...
    key: "industry",
    options: ["IT", "Banking", "Finance", "Real Estate", "HR", "Healthcare"],
  },
...

  {
    ...
    icon: Clock,
    key: "experience",
    options: ["Fresher", "1+ Years", "2+ Years", "5+ Years"],
  },

  {
    ...
    icon: Code2,
    key: "skills",
    options: ["React", "Next.js", "Node.js", "Java", "Python", "Excel"],
  },
...
export default function FilterCards({
  ...
  return (
    <section className="scrollbar-thin h-[72vh] overflow-y-auto rounded-[1.5rem] border border-slate-200 bg-[#fbf7ef] p-4 scrollbar-thumb-orange-400/40 scrollbar-track-transparent hover:scrollbar-thumb-orange-400 dark:border-white/10 dark:bg-[#050509]">
      <div className="mb-4 flex items-center justify-between gap-3 border-b border-slate-200 pb-3 dark:border-white/10">
        ...
        {Object.keys(selectedFilters).length > 0 && (
          <button
            ...
            className="flex items-center gap-1 rounded-full bg-orange-500/10 px-3 py-1.5 font-unbounded text-[10px] font-medium text-orange-600 transition hover:bg-orange-500/20 dark:text-orange-300"
          >
            <X className="h-3 w-3" />
            Clear
          </button>
